...
\vspace{5cm}
\begin{center} {\Large Anne-lise Caillat , Christophe Dutang,} \end{center}

\begin{center} {\Large Marie V\'eronique Larrieu  et Triet NGuyen} \end{center}
...
par $I_i(t) = \min(L_i-K_i, (X_i(t) - K_i)_+)$ o\`u $K_i$ et $L_i$ sont le seuil et la limite par station. Sur une p\'eriode $T$, l'indice d'une station 
